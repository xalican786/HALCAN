// src/adapters/modempay.js — Halcan ModemPay bridge
// XC/USDC → fiat withdrawal
// Universal adapter — same interface as XSMI/Xalican/ALUCARD
// Activated by MODEMPAY_SECRET_KEY env var
...
export async function send(key, params) {
  ...
  if (!key)                   throw new Error('ModemPay key not configured — set MODEMPAY_SECRET_KEY')
